...
- (void)configUI {
    ...
    [importBtn setTitleColor:[UIColor colorWithHexString:@"#FFFFFF"] forState:UIControlStateNormal];
    importBtn.titleLabel.font = K12FONT;
    ...
    [createBtn setTitleColor:[UIColor colorWithHexString:@"#FFFFFF"] forState:UIControlStateNormal];
    [createBtn setImage:[UIImage imageNamed:@"login_create"] forState:UIControlStateNormal];
    createBtn.titleLabel.font = K12FONT;
